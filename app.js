...
// alert("please enter your a valid password?")
...
// var student_name ="huzaifa";
// var age = "19years";
// var courseName web developer";
// alert(student_name + "\n" + age + "\n"  +courseName)
...
// var text = "My emial address"
// var email= "\huzaifakhan2215@gmail.com"
// alert(text + email)
...
// var book = " i am try to learn JS A smarter way to learn";
// alert(book)
...
// var display = "Yah! i learnt javascript program"
// console.log(display)
...
// var visitTime = prompt("Enter your visittime");
// alert("I am visiting this page " + visitTime + " time")
...
// birth year. Show the following message in your browser:
                                 ...
                                 //Answer:
//  var born = prompt("enter your age");
//  console.log("My birth year "+ born + "  Data type of my decleared varible is number")
...
// var  Visitors_name = prompt("enter you name");
    // var  product_title = prompt("enter you product title ");
    // var  product_name = prompt("enter you product name ");
    // var  Qty = +prompt("enter you Quantity ");
    // var  website = prompt("enter you website ");

    // console.log(Visitors_name +"  " +product_title+ "  "+product_name+ "  "+Qty + "  "+website)
...
// 1 2ndVariable (starts with a number)
// 2 my-variable (contains a hyphen)
// 3 hello world (contains a space)
// 4 @symbol (starts with a special character)
...
// var b = +prompt("enter your number")
// c = a/b
// console.log("Divison of   " + a +" and  "+ b +" = "+c)
...
// var b = +prompt("enter your number")
// c = a%b
// console.log("modulus of   " + a +" and  "+ b +" = "+c)
